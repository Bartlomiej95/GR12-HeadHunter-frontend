export const pl = {
    ...
    filterTitlePlace: 'Preferowane miejsce pracy',
    filterPlaceWorkRemote: 'Praca zdalna',
    filterPlaceWorkBiuro: 'Praca w biurze',
    filterTitleTypeContract: 'Oczekiwany typ kontraktu',
    filterTypeContractUOP: 'Umowa o pracę',
    filterTypeContractB2B: 'B2B',
    filterTypeContractUZ: 'Umowa zlecenie',
    filterTypeContractUOD: 'Umowa o dzieło',
    filterTitleSalary: 'Oczekiwane wynagrodzenie miesięczne netto',
    filterPlaceholderFrom: 'np. 1000 zł',
    filterPlaceholderTo: 'np. 10000 zł',
    filterTitleFreeWork: 'Zgoda na odbycie bezpłatnych praktyk/stażu na początek',
